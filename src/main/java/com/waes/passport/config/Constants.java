...
public class Constants {
	...
	public static final String INVALID_ID_PLEASE_TRY_AGAIN = "Invalid ID. Please, try again";
	public static final String ID_NOT_FOUND_PLEASE_TRY_AGAIN = "ID not found. Please, try again";
